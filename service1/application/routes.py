...
def generatehero():
    ...
    heroClass = requests.get('http://service2:5001/get/class')
    race = requests.get('http://service3:5002/get/race')
    weapon = requests.post('http://service4:5003/post/weapon', data=heroClass.text)
